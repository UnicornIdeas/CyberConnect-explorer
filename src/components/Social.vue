<template>
  <v-container class="fill-height main-body">   
    <v-row justify="space-between">
      <v-col cols="3">
        <!-- user card -->
        <v-card  ref="cardref" id="cardid" color="#1e1e29" class="rotated-card" elevation="12">
          <div class="no-rotation">
          <!-- avatar -->
          <v-row align="center">
            <v-avatar size="8vw" class="avatar-style">
              <img
                alt="Avatar"
          ...
          <v-row justify="center">
            <div style="color: #41c8fb" :class="cardtext.title">pisofa.eth</div>
          </v-row>
          ...
          <v-row justify="center" class="follow-row">
            <v-col class="center-column column-left" cols="6">
              <v-row>
                <v-col cols="12" class="no-pad-bottom no-pad-horizontal">
                  <div :class="cardtext.follow">123</div>
                </v-col>
                <v-col cols="12" class="no-pad-top no-pad-horizontal">
                  <div class="font-weight-light grey--text" :class="cardtext.follow">Following</div>
                </v-col>
              </v-row>  
            </v-col>
            ...
            <v-col class="center-column column-right" cols="6">
              <v-row>
                <v-col cols="12" class="no-pad-bottom no-pad-horizontal">
                  <div :class="cardtext.follow">8888</div>
                </v-col>
                <v-col cols="12" class="no-pad-top no-pad-horizontal">
                  <div class="font-weight-light grey--text" :class="cardtext.follow">Followers</div>
                </v-col>
              </v-row> 
            </v-col>
          </v-row>
          ...
          <!-- adresa eth -->
          <div class="mt-6 mb-6">
            <div class="font-weight-light grey--text mb-2" :class="cardtext.address">
              Address
            </div>
            <div :class="cardtext.address">
              0x5c60505E43e7F8c8b27124690A4e3031bf2332bf
            </div>
          </div>
      ...
      <!-- card background -->
      <v-card elevation="12" :style="{ width:cardwidth, height:cardheight, top:cardtop, left: cardleft}" class="background-card"/>
      ...
      <v-col cols="8">
        <v-data-table :items="connections" class="connections-table">
          <template
            v-slot:item="{ item }">
            <v-card class="mb-6 connection-card pt-4 pb-4 pl-6 pr-6" elevation="0">
  ...
  data(){
    return{
      ...
      connections:[
        {
          name:"nume",
          address:"0x5c60505E43e7F8c8b27124690A4e3031bf2332bf",
...
.background-card{
  background: linear-gradient(201deg, rgba(68,196,253,1) 0%, rgba(25,172,167,1) 100%) !important;
  position:absolute;
  z-index: 1;
  transform: rotate(-3deg);
}
